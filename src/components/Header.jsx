        ...
        <header className="header">
            <nav className="nav">
                <div className="container flexbox flexbox--header">
                    <a href="#hero">
                        <img src="/perrito-logo-web.webp" alt="Jeferson" width={48} height={48} className="img img--logo" />
                    </a>
                    <div ref={offCanvas} className="off-canvas off-canvas--right off-canvas--mobile">
                        <div className="off-canvas__child">
                            ...
                            <ul className="list flexbox flexbox--center flexbox--responsive h-100 gap-2xs">
